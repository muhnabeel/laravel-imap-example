  ...
  <div class="email-user-list">
    <ul class="email-media-list">
       ...
       @foreach($paginator as $oMessage)
           ...
           <!-- <h1 onclick="getMessageDet(2)">getMessageDet</h1>
 -->
       <?php 
    ...
    $body = $oMessage->getSubject();
      ...
      <li class="media mail-read" onclick="getMessageDet(<?php echo $uid; ?>)" >
        ...
        <div class="media-body" >
          <div class="mail-details">
            <div class="mail-items">
              <h5 class="mb-25">{{$oMessage->getFrom()}}</h5>
              <span class="text-truncate">🎯 {{$oMessage->getSubject()}} </span>
            </div>
            <div class="mail-meta-item">
              ...
              <span class="mail-date">
                ...
                $date=date_create($oMessage->getDate());
          ...
          <div class="mail-message">
            <p class="text-truncate mb-0">
              ...
              //echo  $oMessage->fromaddress;
          
          echo $oMessage->getTextBody();
          //echo $oMessage->getAttachments();
...
<div class="email-app-details">
  ...
  <div class="email-detail-header">
    <div class="email-header-left d-flex align-items-center">
      <span class="go-back mr-1"><i data-feather="chevron-left" class="font-medium-4" onclick="thishide()"></i></span>
...
@foreach($paginator as $oMessage)
    ...
    <div class="row" id="emaildet{{$oMessage->getUid()}}" style="display: none;">
      <div class="col-12">
        <div class="card">
          <div class="card-header email-detail-head">
            <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div class="mail-items">
                <h5 class="mb-0">{{$oMessage->getFrom()}}</h5>
            ...
            <div class="mail-attachments">
              ...
              <div class="d-flex flex-column">
                <a href="javascript:void(0);" class="mb-50">
                  <img src="{{ asset('images/icons/doc.png') }}" class="mr-25" alt="png" height="18" />
                  <small class="text-muted font-weight-bolder">interdum.docx</small>
                </a>
                <a href="javascript:void(0);">
                  <img src="{{ asset('images/icons/jpg.png') }}" class="mr-25" alt="png" height="18" />
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content p-0">
      ...
      <div class="modal-body flex-grow-1 p-0">
          ...
          <form action="{{ url('/admin/compose_mail') }}" method="post" id="emailForm">
              @csrf
          ...
          <div class="compose-mail-form-field select2-primary">
            ...
            <div class="flex-grow-1">
              <select class="select2 form-control w-100" id="email-to" name="to" multiple required="">
                <option data-avatar="1-small.png" value="jamesthowx@gmail.com">Jane Foster</option>
                <option data-avatar="3-small.png" value="jamesthowx@gmail.com">Donna Frank</option>
                <option data-avatar="5-small.png" value="jamesthowx@gmail.com">Gabrielle Robertson</option>
                <option data-avatar="7-small.png" value="hashim1805a@aptechgdn.net">Lori Spears</option>
              </select>
            </div>
            <div>
          ...
          <textarea name="message" value="worksssssssssssssss" style="display: none;"></textarea>
...
<script type="">
  ...
  // var divsToHide = document.getElementsByClassName("hidedetails");
  ...
  //  divsToHide.style.display = 'none';
    ...
    function getMessageDet(uid) {
      ...
      jQuery(document).ready(function(){
       ...
       $('#maindetails').html($('#emaildet'+uid).html());

      });


     // var x = document.getElementById('emaildet'+uid);

     // x.style.display = 'block';

            // $.ajax({
            //    type:'GET',
            //    url:'/admin/getdetails/'+uid,
...
$("#emailForm").on("submit", function () {
        ...
        var hvalue = $('.editor').text();
           var myEditor = document.querySelector('.editor')
   var html = myEditor.children[0].innerHTML
        $(this).append("<textarea name='message' style='display:none'>"+html+"</textarea>");
       });
